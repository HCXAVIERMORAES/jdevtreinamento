...
/**
 * O tipo enum é uma estrutura de colessão com dados pré-definidos e imutavesi
 * e assim o acesso sera uma alternativa de uso do enunm.
 * O enum é um array, ou uma lista de dados do tipo valor e descrição, separado por ',' e finalizado por ';'.
 * o ENU
 *
 */
